...
var omah = function(){
	...
	//		if (jQuery('#confirm-password').attr('type') == 'password') {
	//			jQuery('#confirm-password').attr('type', 'text');
	//		} else if (jQuery('#confirm-password').attr('type') == 'text') {
	//			jQuery('#confirm-password').attr('type', 'password');
	//		}
	//	});
	//}

	//var handleshowPassNew = function () {
	//	jQuery('.show-pass').on('click', function () {
	//		jQuery(this).toggleClass('active');
	//		if (jQuery('#new-password').attr('type') == 'password') {
	//			jQuery('#new-password').attr('type', 'text');
	//		} else if (jQuery('#new-password').attr('type') == 'text') {
	//			jQuery('#new-password').attr('type', 'password');
	//		}
	//	});
	//}

	//var handleshowPassCurrent = function(){
	//	jQuery('.show-pass').on('click',function(){
	//		jQuery(this).toggleClass('active');
	//		if(jQuery('#current-password').attr('type') == 'password'){
	//			jQuery('#current-password').attr('type','text');
	//		}else if(jQuery('#current-password').attr('type') == 'text'){
	//			jQuery('#current-password').attr('type','password');
	//		}
	//	});
	//}
	...
	$(function () {
		$('.show-pass').on('click', function () {
			...
			// alterna os ícones (mostrar/esconder)
			$this.toggleClass('active');
			$this.find('.fa-eye').toggle(!isPassword);
			$this.find('.fa-eye-slash').toggle(isPassword);
		});
	});
